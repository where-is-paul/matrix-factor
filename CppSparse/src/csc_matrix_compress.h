//-*- mode: c++ -*-
#ifndef _CSC_MATRIX_COMPRESS_H_
#define _CSC_MATRIX_COMPRESS_H_

#include <numeric>


template<class idx_type, class el_type>
void csc_matrix<idx_type, el_type> :: compress(const triplet_matrix<idx_type, el_type>& triplet)
{
