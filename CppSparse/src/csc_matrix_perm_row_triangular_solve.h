...
void csc_matrix<idx_type, el_type> :: lower_row_perm (idx_vector_type& perm) const
{
...
template<class idx_type, class el_type>
void csc_matrix<idx_type, el_type> :: upper_row_perm (idx_vector_type& perm) const
{
    perm.resize(m_n_cols);
    std::fill(perm.begin(), perm.end(), npos);
...
template<class idx_type, class el_type>
void csc_matrix<idx_type, el_type> :: lower_row_perm_solve  (elt_vector_type& b) const
{
...
template<class idx_type, class el_type>
void csc_matrix<idx_type, el_type> :: upper_row_perm_solve  (elt_vector_type& b) const
{
    idx_vector_type perm(m_n_cols);
    upper_row_perm(perm);
