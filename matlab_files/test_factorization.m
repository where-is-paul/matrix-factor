...
=======
mat_name = 'aug3dcqp_rcm_perm';
base = '';
%base = 'C:\Users\Paul\Documents\My Dropbox\Online Resources\My Homework\UBC 2011W\NSERC\matrix-factor-recode\';
>>>>>>> d140a89f0772df5ce85f848181496db0e696bb50
...
fprintf('The residual is %d.\n', norm(A(p,p) - l*d*l', 1)/norm(A, 1));spy(A(p,p)); figure; spy(abs(l*d*l') > 1e-8);

e = ones(size(A,1),1);
<<<<<<< HEAD
gmres(A(p,p),e,5,1e-6,200,l*d+1e-8*speye(size(A)), l');
=======
