...
class skew_solver
{
	public:
		...
		*/
		void solve_pp(double fill_factor, double tol, double pp_tol)
		{
		...
		void solve_mpp(double fill_factor, double tol, double pp_tol)
		{
			perm.reserve(A.n_cols());
			// for (int i = 0; i < A.n_cols(); i++) {
				// perm.push_back(i);
		...
		void solve_rp(double fill_factor, double tol, double pp_tol)
		{
			perm.reserve(A.n_cols());
			// for (int i = 0; i < A.n_cols(); i++) {
				// perm.push_back(i);
